...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Atualização de Compra</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-success">
                                <div class="card-header">
                                    <h3 class="card-title">Formulário de Atualização das Compras Realizadas</h3>
                            ...
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Precço da Compra</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Quantidade da Compra</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button class="btn btn-success btn-block" id="btn_actualizar_compra">Atualizar Compra</button>
                                        </div>
                                    </div>
                                    <script>
                                        $('#btn_actualizar_compra').click(function () {
                                            ...
                                            if(id_producto == ""){
                                                $('#id_producto').focus();
                                                alert("Deve preencher todos os campos de produtos");
                                            }else if(fecha_compra == ""){
                                                $('#fecha_compra').focus();
                                                alert("Deve preencher todos os campos de Data Compra");
                                            }else if(comprobante == ""){
                                                $('#comprobante').focus();
                                                alert("Deve preencher todos os campos de Comprovante");
                                            }else if (precio_compra == ""){
                                                $('#precio_compra_controlador').focus();
                                                alert("Deve preencher todos os campos de Preço de Compra");
                                            }else if( cantidad_compra == ""){
                                                $('#cantidad_compra').focus();
                                                alert("Deve preencher todos os campos de Quantidades");
                                            }
                                            else{
    ...
    $(function () {
        $("#example2").DataTable({
            ...
            "language": {
                ...
                "infoFiltered": "(Filtrado de _MAX_ total Fornecedores)",
                "infoPostFix": "",
                "thousands": ",",
