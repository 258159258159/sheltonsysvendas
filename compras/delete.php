                        ...
                        <div class="col-md-12">
                            <div class="card card-danger">
                                <div class="card-header">
                                    <h3 class="card-title">Tem certeza que deseja Excluir a Compra?</h3>
                            ...
                            <div class="card card-outline card-danger">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                               <button class="btn btn-danger btn-block" id="btn_eliminar"><i class="fa fa-trash"></i> Excluir</button>
                                            </div>
                                        </div>
                                        ...
                                        <script>
                                            $('#btn_eliminar').click(function () {
                                                ...
                                                Swal.fire({
                                                    title: 'Está seguro de Excluir a Compra?',
                                                    icon: 'question',
