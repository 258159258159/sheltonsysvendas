...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Registro de uma Nova Compra</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Formulário de Compras</h3>
                                ...
                                <div class="card-body" style="display: block;">
                                    <div style="display: flex;">
                                        ...
                                        <!--Modal para visualizar dados do fornecedores-->
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <button href="" class="btn btn-info btn-sm" id="btn_selecionar<?php echo  $id_producto; ?>">
                                                                                    Selecionar
                                                                                </button>
                                                                                <script>
                                    ...
                                    <div class="row" style="font-size: 12px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nombre" id="nombre_producto" type="text" class="form-control" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="" type="text" class="form-control" id="usuario_producto" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <center>
                                                    <img src="<?php echo $URL . "/almacen/img_productos/" . @$imagen; ?>" id="img_producto" width="80%" alt="">
                                                </center>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: flex;">
                                        ...
                                        <div class="modal fade" id="modal-buscar_proveedor">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background-color: #1d36b6; color: white;">
                                                        <h4 class="modal-title">Busca de Fornecedor</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                            ...
                                                            <table id="example2" class="table table-bordered table-striped table-sm">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            <center>Nome do Fornecedor</center>
                                                                        </th>
                                                                        <th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <button href="" class="btn btn-info btn-sm" id="btn_selecionar_proveedor<?php echo  $id_proveedor; ?>">
                                                                                    Selecionar
                                                                                </button>
                                                                                <script>
                                                                            ...
                                                                            <td>
                                                                                <a href="https://wa.me/55<?php echo $proveedores_dato['celular']; ?>" target="_blank" class="btn btn-success btn-sm">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            ?>
                                            <div class="form-group">
                                                <label for="">Número da Compra</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Comprovante da Compra</label>
