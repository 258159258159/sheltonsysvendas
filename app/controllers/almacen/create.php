...
VALUES  (:codigo, :nombre,:descripcion,:stock,:stock_minimo,:stock_maximo,:precio_compra,:precio_venta,:fecha_ingreso,:imagen,
...
if ($sentencia->execute()) {
    session_start();
    $_SESSION['mensaje'] = "Produto foi registrado corretamente.";
