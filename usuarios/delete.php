                ...
                <div class="col-md-5">
                    <div class="card card-danger">
                        <div class="card-header">
                            <h3 class="card-title">Você tem certeza que deseja <b>EXCLUIR</b> o usuário ?</h3>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="../app/controllers/usuarios/delete_usuario.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" id="email" class="form-control" value="<?php echo $rol; ?>" disabled>
                                        </div>
                                        <hr>
                                        <div class="form-group">
                                            <a href="index.php" class="btn btn-secondary">Voltar</a>
                                            <button class="btn btn-danger"><b>E X C L U I R</b></button>
                                        </div>
                                    </form>
